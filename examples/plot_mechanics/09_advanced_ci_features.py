...
results = fitter.confidence_intervals(ci_levels=[68, 90, 95, 99], n_bootstrap=1000, overall_ci=True, seed=42)

fig1, ax1 = plt.subplots(figsize=(12, 6))
fitter.plotter.plot_fit(axis=ax1, show_individuals=True)
fitter.plotter.plot_confidence_intervals(ci_levels=[68, 90, 95, 99], results=results, overall_ci=True, axis=ax1)
ax1.set_title(
    "Multiple CI Levels with Graduated Alpha Transparency\n"
...
results_extended = fitter.confidence_intervals(
    ci_levels=[68, 95], n_bootstrap=1000, overall_ci=True, seed=42, x_range=x_extended
)
...
fitter.plotter.plot_confidence_intervals(ci_levels=[68, 95], results=results_extended, overall_ci=True, axis=ax2)
...
results_individual = fitter.confidence_intervals(
    ci_levels=95, n_bootstrap=1000, overall_ci=False, individual_ci=True, seed=42
)

fig3, ax3 = plt.subplots(figsize=(12, 6))
fitter.plotter.plot_fit(axis=ax3, show_individuals=True)
fitter.plotter.plot_confidence_intervals(ci_levels=95, results=results_individual, overall_ci=False, individual_ci=True,
                                         axis=ax3)
...
results_both = fitter.confidence_intervals(ci_levels=95, n_bootstrap=1000, overall_ci=True, individual_ci=True, seed=42)

fig4, (ax4a, ax4b) = plt.subplots(1, 2, figsize=(16, 6))

# Plot overall CI
fitter.plotter.plot_fit(axis=ax4a)
fitter.plotter.plot_confidence_intervals(ci_levels=95, results=results_both, overall_ci=True, individual_ci=False,
                                         axis=ax4a)
...
fitter.plotter.plot_confidence_intervals(ci_levels=95, results=results_both, overall_ci=False, individual_ci=True,
                                         axis=ax4b)
