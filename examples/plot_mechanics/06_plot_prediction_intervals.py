...
results_ci = fitter.confidence_intervals(ci_levels=95, n_bootstrap=300, overall_ci=True, individual_ci=False, seed=0)
...
fitter.plotter.plot_confidence_intervals(ci_levels=95, results=results_ci, overall_ci=True, individual_ci=False,
                                         axis=ax_ci)
