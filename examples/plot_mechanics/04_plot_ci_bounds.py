...
Demonstrates:
  - Single CI level (95 %)
  - Multiple CI levels drawn as nested bands
  - overall_ci vs individual_ci
  - plot_it=True short-cut on fitter.ci_bounds()

Note: bootstrap is slow by default (n_bootstrap=1000).
      This example uses n_bootstrap=200 for speed.
"""
